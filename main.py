...
while len(player1_hand) > 0 and len(player2_hand) > 0:
    ...
    player2_played_value = get_card_value(player2_played_card)
    ...
    # If it's a tie, the players go to WAR!
        ...
        ### !!! --- I ran into a test scenario where player 2 did not have enough cards to play WAR --- !!! ###
        ### !!! --- I believe that is a losing scenario for that player --- !!! ###
        ...
        # Set the value of the face up cards
        player1_faceup_value = get_card_value(player1_faceup_card)
        player2_faceup_value = get_card_value(player2_faceup_card)
        ...
        elif player2_faceup_value > player1_faceup_value:
            # Print the winner of the round
